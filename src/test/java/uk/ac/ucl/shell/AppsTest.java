...
//		fileWriter.write("This is a line containing the pattern."+System.getProperty("line.separator")+"This is a line that doesn't.");
//		fileWriter.close();
//
//		fileWriter = new FileWriter(abcPath);
//		fileWriter.write("AAA"+System.getProperty("line.separator")+"BBB"+System.getProperty("line.separator")+"CCC");
//		fileWriter.close();
//
...
//		fileWriter.write("Line 1"+System.getProperty("line.separator")+"Line 2"+System.getProperty("line.separator")+"Line 3");
//		fileWriter.close();
//
//		fileWriter = new FileWriter(mixedContent);
//		fileWriter.write("This is a line."+System.getProperty("line.separator")+"Line 2"+System.getProperty("line.separator")+"Another line.");
//		fileWriter.close();
//
...
//		fileWriter.write("Sample"+System.getProperty("line.separator")+"empty"+System.getProperty("line.separator")+"file"+System.getProperty("line.separator"));
//		fileWriter.close();
//
...
//		Application Echo = new Echo();
//		Echo.exec(new ArrayList<String>(), "input here"+System.getProperty("line.separator")+" more input here", writer);
//
//		String output = capture.toString();
//		String expected = System.getProperty("line.separator");
//
...
//
//		String output = capture.toString();
//		String expected = "Line 1"+System.getProperty("line.separator")+"Line 2"+System.getProperty("line.separator")+"Line 3"+System.getProperty("line.separator");
//		assertEquals(expected, output);
//	}
//
//	@Test
...
//
//		String output = capture.toString();
//		String expected = "This is a line."+System.getProperty("line.separator")+"Line 2"+System.getProperty("line.separator")+"Another line."+System.getProperty("line.separator");
//
//		assertEquals(expected, output);
//	}
//
...
//		String expectedOutput = "This is a single line."+System.getProperty("line.separator") + standardInput + System.getProperty("line.separator");
//
//		Application cat = new Cat();
...
//		String expectedOutput = "This is a single line."+System.getProperty("line.separator")+"Line 1"+System.getProperty("line.separator")+"Line 2"+System.getProperty("line.separator")+"Line 3"+System.getProperty("line.separator");
//
//		Application cat = new Cat();
//		cat.exec(args, "", writer);
//
...
//		Application grep = new Grep();
//		grep.exec(args, "", writer);
//		assertEquals("grep: file not found: invalidfile.txt"+System.getProperty("line.separator"), outContent.toString());
//	}
//
//	@Test
...
//		Application grep = new Grep();
//		grep.exec(args, "", writer);
//		assertEquals("grep: access not permitted to file " + multipleLinesFileName + System.getProperty("line.separator"), outContent.toString());
//	}
//
...
//		grep.exec(args, "", writer);
//		String output = capture.toString();
//		String expected = "multipleLines.txt: Line 1"+System.getProperty("line.separator") + "multipleLines.txt: Line 2"+System.getProperty("line.separator") + "multipleLines.txt: Line 3"+System.getProperty("line.separator")
//				+ "";
//		assertEquals(expected, output);
//	}
//
...
//		cut.exec(args, "", writer);
//		String output = capture.toString();
//		String expected = "Line"+System.getProperty("line.separator")+"Line"+System.getProperty("line.separator")+"Line"+System.getProperty("line.separator")+" 1"+System.getProperty("line.separator")+" 2"+System.getProperty("line.separator")+" 3"+System.getProperty("line.separator");
//		assertEquals(expected, output);
//	}
//
//	@Test
...
//		String output = capture.toString();
//		String expected = "Line"+System.getProperty("line.separator")+" 1"+System.getProperty("line.separator")+"L"+System.getProperty("line.separator");
//		assertEquals(expected, output);
//	}
//
//	// Find
...
//		find.exec(args, "", writer);
//		String output = capture.toString();
//		assertEquals("subDirectory"+System.getProperty("file.separator")+"subemptyFile.txt"+System.getProperty("line.separator"), output);
//	}
//
//	@Test
...
//
//		String output = capture.toString();
//		assertEquals("Line 3"+System.getProperty("line.separator")+"Line 2"+System.getProperty("line.separator")+"Line 1" + System.getProperty("line.separator"), output);
//	}
//
//	@Test
